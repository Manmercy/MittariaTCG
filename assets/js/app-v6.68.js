...
function howToPlayMarkup(lang){
  if(lang === 'th') return `
    <figure class="how-visual"><img src="assets/embedded/how_to_play_table_16x9.jpg" alt="สนาม MITTARIA TCG แบบ 5 เลน พร้อม Gate และ Character"><figcaption>ภาพรวมสนาม 5 เลน • Gate • Character • Turn Flow</figcaption></figure>
    <div class="how-sec"><h2>เป้าหมาย</h2><p>MITTARIA TCG เป็นเกม 1v1 ใช้สนาม 5 เลน ทำลาย Gate เพื่อเปิดทางโจมตี Lead Card จากนั้นลด LP ของ Lead ฝ่ายตรงข้ามให้เหลือ 0 เพื่อชนะ ไพ่ Gate ที่ถูกทำลายจะเปิดและกลับขึ้นมือเจ้าของ</p></div>
    <div class="how-sec important-deck-rule"><h2>การจัด Deck</h2><div class="rule-box"><h4>1 Deck = 40 ใบ</h4><p>แนะนำ <strong>Character 24</strong> / <strong>Companion 8</strong> / <strong>Spell 8</strong> และใส่การ์ดชื่อเดียวกันได้สูงสุด <strong>3 ใบ</strong></p></div></div>
    <div class="how-sec"><h2>ประเภทการ์ด</h2><div class="rule-box"><h4><span class="type-badge tb-char">CHARACTER</span> ตัวหลักบนสนาม</h4><p>ใช้โจมตี ป้องกัน และสังเวยเพื่อจ่าย Crystal Cost เลือก Attack หรือ Guard Formation ตอนลง</p></div><div class="rule-box"><h4><span class="type-badge tb-comp">COMPANION</span> การ์ดสนับสนุน</h4><p>ติดกับ Character เพื่อเพิ่มพลังหรือความสามารถ และออกจากสนามพร้อมตัวที่ติดอยู่</p></div><div class="rule-box"><h4><span class="type-badge tb-spell">SPELL</span> เอฟเฟกต์ทันที</h4><p>ใช้จากมือเพื่อจั่ว ย้ายเลน ชุบชีวิต ซ่อม Gate หรือแก้สถานการณ์</p></div></div>
    <div class="how-sec"><h2>ลำดับเทิร์น</h2><div class="rule-box"><h4>① Draw</h4><p>จั่ว 2 ใบ ยกเว้นเทิร์นแรกไม่จั่ว มือสูงสุด 7 ใบ</p></div><div class="rule-box"><h4>② Main</h4><p>ลงการ์ด จ่าย Cost ติด Companion ใช้ Spell หรือเปลี่ยน Formation</p></div><div class="rule-box"><h4>③ Battle</h4><p>เลือก Character โจมตีเป้าหมายในเลนเดียวกัน ตัวที่เพิ่งลงยังโจมตีไม่ได้</p></div><div class="rule-box"><h4>④ End</h4><p>จบเทิร์นและส่งการเล่นให้อีกฝ่าย</p></div></div>
    <div class="how-sec"><h2>Crystal Cost</h2><p>สังเวย Character บนสนามเพื่อสร้าง Crystal ตามค่า Crystal Value</p><table class="tbl"><tr><th>Character Rarity</th><th>Summon Cost</th><th>Crystal Value</th></tr><tr><td>Common</td><td>0</td><td>1</td></tr><tr><td>Rare</td><td>0</td><td>1</td></tr><tr><td>Epic</td><td>1</td><td>1</td></tr><tr><td>Legendary</td><td>2</td><td>2</td></tr></table></div>
    <div class="how-sec"><h2>การต่อสู้</h2><table class="tbl"><tr><th>เป้าหมาย</th><th>เปรียบเทียบ</th><th>ผล</th></tr><tr><td>Attack Formation</td><td>ATK vs ATK</td><td>ค่าที่สูงกว่าชนะ อีกฝ่ายถูกทำลาย</td></tr><tr><td>Guard Formation</td><td>ATK vs DEF</td><td>ถ้า ATK สูงกว่า DEF ฝ่ายรับถูกทำลาย</td></tr><tr><td>เสมอ</td><td>ค่าเท่ากัน</td><td>ไม่มีการ์ดถูกทำลาย</td></tr><tr><td>เลนว่างและมี Gate</td><td>โจมตี Gate</td><td>ทำลาย Gate 1 ใบ</td></tr><tr><td>เลนว่างและ Gate ถูกทำลายแล้ว</td><td>Direct Attack</td><td>สร้างความเสียหายต่อ Lead LP</td></tr></table></div>
    <div class="how-sec"><h2>ชนะและแพ้</h2><ul><li>ลด LP ของ Lead Card ฝ่ายตรงข้ามให้เหลือ 0 = ชนะ</li><li>Deck หมดเมื่อต้องจั่ว = แพ้</li></ul></div>`;
  return `
    <figure class="how-visual"><img src="assets/embedded/how_to_play_table_16x9.jpg" alt="MITTARIA TCG five-lane table setup with Gates and Character cards"><figcaption>Five-lane table • Gates • Characters • Turn flow</figcaption></figure>
    <div class="how-sec"><h2>Objective</h2><p>MITTARIA TCG is a 1v1 game played across five lanes. Break a Gate to open its lane, then attack the enemy Lead Card. Reduce the enemy Lead LP to 0 to win. A destroyed Gate is revealed and returned to its owner's hand.</p></div>
    <div class="how-sec important-deck-rule"><h2>Build a Deck</h2><div class="rule-box"><h4>1 Deck = 40 Cards</h4><p>Recommended: <strong>24 Characters</strong> / <strong>8 Companions</strong> / <strong>8 Spells</strong>. Include no more than <strong>3 copies</strong> of the same card.</p></div></div>
    <div class="how-sec"><h2>Card Types</h2><div class="rule-box"><h4><span class="type-badge tb-char">CHARACTER</span> Your field unit</h4><p>Characters attack, guard Gates, and can be sacrificed for Crystal Cost. Choose Attack or Guard Formation when played.</p></div><div class="rule-box"><h4><span class="type-badge tb-comp">COMPANION</span> Attach support</h4><p>Attach to a Character for a stat bonus or ability. It leaves the field with that Character.</p></div><div class="rule-box"><h4><span class="type-badge tb-spell">SPELL</span> Instant effect</h4><p>Play from hand to draw, move lanes, revive a Character, restore a Gate, or change the battle.</p></div></div>
    <div class="how-sec"><h2>Turn Structure</h2><div class="rule-box"><h4>① Draw</h4><p>Draw 2 cards. The first player draws 0 on turn one. Maximum hand size is 7.</p></div><div class="rule-box"><h4>② Main</h4><p>Play cards, pay Costs, attach Companions, cast Spells, or change Formation.</p></div><div class="rule-box"><h4>③ Battle</h4><p>Choose a Character to attack in the same lane. A newly played Character cannot attack this turn.</p></div><div class="rule-box"><h4>④ End</h4><p>End your turn and pass play to the opponent.</p></div></div>
    <div class="how-sec"><h2>Crystal Cost</h2><p>Sacrifice Characters on your field to generate their Crystal Value.</p><table class="tbl"><tr><th>Character Rarity</th><th>Summon Cost</th><th>Crystal Value</th></tr><tr><td>Common</td><td>0</td><td>1</td></tr><tr><td>Rare</td><td>0</td><td>1</td></tr><tr><td>Epic</td><td>1</td><td>1</td></tr><tr><td>Legendary</td><td>2</td><td>2</td></tr></table></div>
    <div class="how-sec"><h2>Combat</h2><table class="tbl"><tr><th>Target</th><th>Compare</th><th>Result</th></tr><tr><td>Attack Formation</td><td>ATK vs ATK</td><td>Higher value wins; the loser is destroyed.</td></tr><tr><td>Guard Formation</td><td>ATK vs DEF</td><td>If ATK is higher, the defender is destroyed.</td></tr><tr><td>Tie</td><td>Equal values</td><td>No card is destroyed.</td></tr><tr><td>Empty lane with a Gate</td><td>Attack the Gate</td><td>Destroy one Gate.</td></tr><tr><td>Empty lane with no Gate</td><td>Direct Attack</td><td>Deal damage to the enemy Lead LP.</td></tr></table></div>
    <div class="how-sec"><h2>Win or Lose</h2><ul><li>Reduce the enemy Lead Card LP to 0 to win.</li><li>If your Deck is empty when you must draw, you lose.</li></ul></div>`;
}
function updateLanguageUI(){
  ...
  const howBody = document.querySelector('#sc-how .how-body');
  if (howBody) howBody.innerHTML = howToPlayMarkup(currentLang);
  ...
  setText('deck-slot-label', currentLang === 'th' ? 'ช่องบันทึก DECK' : 'DECK SLOTS');
  setText('btn-save-slot-inline', currentLang === 'th' ? 'บันทึกช่อง' : 'Save Slot');
  setText('btn-random-build', currentLang === 'th' ? '🎲 สุ่ม Deck' : '🎲 Randomize');
  setText('btn-clear-deck', currentLang === 'th' ? 'ล้างการ์ด' : 'Clear Cards');
  setText('btn-reset-custom', currentLang === 'th' ? '↺ Deck เริ่มต้น' : '↺ Reset Default');
  setText('btn-save-slot-bottom', currentLang === 'th' ? 'บันทึกช่อง' : 'Save Slot');
  setText('btn-save-play-bottom', currentLang === 'th' ? 'บันทึกและเล่น' : 'Save & Play');
  ...
  if (dbHelp) dbHelp.innerHTML = currentLang === 'th'
    ? '<strong>กติกาจัด Deck:</strong> Deck ต้องมี 40 ใบ แนะนำ <strong>Character 24</strong> / <strong>Companion 8</strong> / <strong>Spell 8</strong> กด + / − เพื่อปรับจำนวน และใส่ซ้ำได้สูงสุด <strong>3 ใบต่อชื่อการ์ด</strong>'
    : '<strong>Deck Rule:</strong> 40 cards total. Recommended ratio: <strong>24 Character</strong> / <strong>8 Companion</strong> / <strong>8 Spell</strong>. Tap + / − to adjust copies. Max <strong>3 copies per card</strong>.';
  updateAiModeUI();
  renderDeckSlotsUI();
}
...
// ============================================================
let G = {};
const BUILD_VERSION = 'v6.68 Ordered Collection Edition';
let msgTimer = null;
...
function saveDeckToSlot() {
  ...
  if (arr.length !== 40) {
    showMsg(currentLang === 'th' ? 'Deck ต้องมี 40 ใบพอดี' : 'Deck must contain exactly 40 cards');
    return false;
  }
  CUSTOM_PDECK = arr;
  try {
  ...
  renderDeckSlotsUI();
  showMsg(`Saved Slot ${CURRENT_DECK_SLOT}`);
  return true;
}
...
function renderDeckSlotsUI() {
  for (let slot=1; slot<=3; slot++) {
    ...
    if (!btn) continue;
    let name = `Slot ${slot}`;
    try { name = localStorage.getItem(deckNameKey(slot)) || name; } catch(e) {}
    btn.textContent = `${slot}. ${name}`;
    btn.classList.toggle('active', slot === CURRENT_DECK_SLOT);
  }
  const input = document.getElementById('deck-name-input');
  if (input) {
...
function setDeckCount(id, delta) {
  ...
  const total = deckBuilderArray().length;
...
function saveCustomDeck() {
  ...
  CUSTOM_PDECK = arr;
  try { localStorage.setItem('mittaria_custom_deck_v1', JSON.stringify(arr)); } catch(e) {}
  saveDeckToSlot();
  showMsg(currentLang === 'th' ? 'บันทึก Deck แล้ว' : 'Deck saved');
  return true;
}
...
function renderDeckCurrentList() {
  ...
  root.innerHTML = groups.map(([type,title,cls]) => {
    ...
    return `<div class="deck-zone ${cls}">
      <div class="deck-zone-title">${title} <small>${ids.reduce((sum,id)=>sum+(counts[id]||0),0)}</small></div>
...
function renderDeckBuilder() {
  ...
  if (ch) ch.textContent = stats.char;
  if (co) co.textContent = stats.companion;
  if (sp) sp.textContent = stats.spell;
  ...
  function item(card) {
    ...
    const full = n >= 3 || stats.total >= 40;
    return `
      <div class="deck-pick-card cl-${card.rarity} type-${card.type} ${n>0?'in-deck':''} ${n>=3?'maxed':''}" role="button" tabindex="0" aria-label="View ${card.name} details" onclick="showCardDetailFromId('${card.id}')" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();showCardDetailFromId('${card.id}')}">
        ...
        <div class="deck-pick-body">
          ...
          <div class="deck-pick-controls">
            ...
            <button aria-label="Add one ${card.name}" onclick="event.stopPropagation(); setDeckCount('${card.id}', 1)" ${full?'disabled':''}>+</button>
          </div>
        </div>
      </div>`;
  }
...
function startGame() {
  ...
  showScreen('sc-game');
  initGame();
  setGameLogCollapsed(window.matchMedia('(max-width: 900px)').matches);
}
